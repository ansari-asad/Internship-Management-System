...
<?php
	...
	if(isset($_POST['update_password'])){
		...
		$sqlPass = "SELECT * FROM studentlogin WHERE password = '$current_password' AND email = '$email'";
		...
		if($confirm_password != $new_password){
			...
			$updatePassword = "UPDATE studentlogin SET password = '$new_password' WHERE email = '$email'";
